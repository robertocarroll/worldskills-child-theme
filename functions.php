...
function wp_customizer_setting($wp_customize) {
 ...
 //https://wordpress.stackexchange.com/questions/174147/calling-the-menu-title-within-wp-nav-menu-array-function
    ...
    function find_replace_facebook( $items, $args ) {
        $items = str_replace(
            '%FACEBOOK_SVG%', 
            ' <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" class="mr-2" fill="currentColor" aria-hidden="true" focusable="false">
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_facebook', 10, 2 );   

    function find_replace_twitter( $items, $args ) {
        $items = str_replace(
            '%TWITTER_SVG%', 
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_twitter', 10, 2 );   

    function find_replace_youtube( $items, $args ) {
        $items = str_replace(
            '%YOUTUBE_SVG%', 
            ' <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_youtube', 10, 2 );   

    function find_replace_flickr( $items, $args ) {
        $items = str_replace(
            '%FLICKR_SVG%', 
            ' <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="mr-2" aria-hidden="true" focusable="false" fill="currentColor" viewBox="0 0 1792 1792">
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_flickr', 10, 2 );   

    function find_replace_instagram( $items, $args ) {
        $items = str_replace(
            '%INSTAGRAM_SVG%', 
            '  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_instagram', 10, 2 );   


    function find_replace_linkedin( $items, $args ) {
        $items = str_replace(
            '%LINKEDIN_SVG%', 
            '  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true" focusable="false" class="mr-2">
    ...
    add_filter( 'wp_nav_menu_items', 'find_replace_linkedin', 10, 2 );   


    function find_replace_tiktok( $items, $args ) {
        $items = str_replace(
            '%TIKTOK_SVG%', 
            '    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mr-2" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
